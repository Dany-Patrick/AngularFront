 ...
 RegionesYcomunas : string[][][];
  ...
  constructor() {
    ...
    this.RegionesYcomunas = [ 
      ...
      [
        [ "Región de Magallanes y de la AntárVca Chilena"],["Punta Arenas", "Laguna Blanca", "Río Verde", "San Gregorio", "Cabo de Hornos (Ex Navarino)", "Antártica", "Porvenir", "Primavera", "Timaukel", "Natales", "Torres del Paine"]
      ],
      [
